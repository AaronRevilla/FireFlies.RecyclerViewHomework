...
public class UserDao extends AbstractDao<User, Long> {
    ...
    */
    public static class Properties {
        ...
        public final static Property Insertion_date = new Property(6, java.util.Date.class, "insertion_date", false, "INSERTION_DATE");
    };
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"USER\" (" + //
                ...
                "\"EMAIL\" TEXT," + // 4: email
                "\"IMG\" TEXT," + // 5: img
                "\"INSERTION_DATE\" INTEGER);"); // 6: insertion_date
    }
    ...
    protected void bindValues(SQLiteStatement stmt, User entity) {
        ...
        java.util.Date insertion_date = entity.getInsertion_date();
        if (insertion_date != null) {
            stmt.bindLong(7, insertion_date.getTime());
        }
    }
    ...
    public User readEntity(Cursor cursor, int offset) {
        User entity = new User( //
            ...
            cursor.isNull(offset + 6) ? null : new java.util.Date(cursor.getLong(offset + 6)) // insertion_date
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, User entity, int offset) {
        ...
        entity.setInsertion_date(cursor.isNull(offset + 6) ? null : new java.util.Date(cursor.getLong(offset + 6)));
     }
